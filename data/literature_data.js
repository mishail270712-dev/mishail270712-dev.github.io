var literatureRules = [
  ...
  {
    "id": "literary_motifs",
    "title": "Литературные мотивы",
    "subject": "literature",
    "group": "theory",
    "content": `
      <h3>Что такое мотив?</h3>
      <p>Повторяющаяся тема или образ.</p>
      <h4>Примеры:</h4>
      <p>Путешествие, возвращение, любовь, смерть.</p>
    `
  },
  {
    "id": "genre_characteristics",
    "title": "Характеристики жанров",
    "subject": "literature",
    "group": "theory",
    "content": `
      <h3>Роман:</h3>
      <p>Развёрнутое произведение с множеством персонажей</p>
      <h3>Рассказ:</h3>
      <p>Краткое произведение с центральным событием</p>
    `
  },
  {
    "id": "russian_classics_analysis",
    "title": "Анализ русской классики",
    "subject": "literature",
    "group": "analysis",
    "content": `
      <h3>Темы:</h3>
      <ul>
        ...
        <li>Человеческая душа</li>
        <li>Общество и личность</li>
      </ul>
    `
  },
  {
    "id": "literary_symbols",
    "title": "Литературные символы",
    "subject": "literature",
    "group": "theory",
    "content": `
      <h3>Что такое символ?</h3>
      <p>Объект, обладающий двойным смыслом.</p>
      <h4>Пример:</h4>
      <p>Сердце — любовь, лёд — холодность.</p>
    `
  },
  {
    "id": "lyrical_hero",
    "title": "Лирический герой",
    "subject": "literature",
    "group": "theory",
    "content": `
      <h3>Что такое?</h3>
      <p>Голос, ведущий повествование в лирике.</p>
      <p>Не всегда автор.</p>
    `
  }
];